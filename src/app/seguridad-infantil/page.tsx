  ...
  return (
    <div className="min-h-screen bg-canvas py-8 px-4">
      <div className="max-w-2xl mx-auto bg-surface rounded-2xl p-8 shadow-sm">
        ...
        <h2 className="text-xl font-bold text-ink mb-1">Estándares de Seguridad Infantil</h2>
        <p className="text-faint text-sm mb-6">Última actualización: 5 de mayo de 2026</p>
        ...
        <Section title="3. Contenido prohibido">
          <p className="text-sm text-muted mb-2">Está estrictamente prohibido publicar, compartir o solicitar:</p>
        ...
        <Section title="4. Mecanismos de denuncia">
          <p className="text-sm text-muted mb-2">Pintó permite a los usuarios denunciar contenido o comportamientos sospechosos a través de:</p>
          <ul className="list-disc pl-5 space-y-1 text-sm text-muted">
        ...
        <Section title="5. Acciones ante infracciones">
          <p className="text-sm text-muted mb-2">Ante cualquier infracción a estos estándares, Pintó tomará las siguientes medidas:</p>
          <ul className="list-disc pl-5 space-y-1 text-sm text-muted">
        ...
        <Section title="7. Contacto">
          <p className="text-sm text-muted">Para denunciar contenido o comportamiento relacionado con la seguridad infantil:</p>
          <ul className="list-disc pl-5 space-y-1 text-sm text-muted">
